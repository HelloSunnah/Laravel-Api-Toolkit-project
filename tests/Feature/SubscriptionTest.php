...
class SubscriptionTest extends TestCase
{
    ...
    public function testViewAllSubscriptionsSuccessfully(): void
    {
        $this->markTestIncomplete('This test case needs review.');
        ...
        $this->json('GET', $this->endpoint)
             ...
             ->assertSee(Subscription::find(rand(1, 5))->name);
    }

    public function testViewAllSubscriptionsByFooFilter(): void
    {
        $this->markTestIncomplete('This test case needs review.');
